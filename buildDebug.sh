...
cd examples
g++ main01.cc -o main01 -g -L/mnt/UbuntuData2/pythiaDevelopment/lib -lpythia8 -I/mnt/UbuntuData2/pythiaDevelopment/include -std=c++20 -Wno-misleading-indentation -Wno-deprecated-declarations
./main01 > main01.txt
