...
double WeakShowerMEs::getTchanneluGuGZME(Vec4ref p1, Vec4ref p2, Vec4ref p3,
  Vec4ref p4, Vec4ref p5) {
...
double WeakShowerMEs::getTchannelududZME(Vec4ref p1,Vec4ref p2,Vec4ref p3,
  Vec4ref p4,Vec4ref p5) {
