...
void Settings::set(Word word, stringref value)
{
...
void Settings::addMode(stringref name, int defaultVal, bool hasMin, bool hasMax, int min, int max, bool boundsError)
{
...
void Settings::addParam(stringref name, double defaultVal, bool hasMin, bool hasMax, double min, double max)
{
...
void Settings::addWord(stringref name, stringref defaultVal)
{
  wordDefault[int(WordMap.at(name))] = defaultVal;
}

void Settings::addFlagList(stringref name, const vector<bool>& defaultVal)
{
  flagListDefault[int(FlagListMap.at(name))] = defaultVal;
}

void Settings::addModeList(stringref name, const vector<int>& defaultVal, bool hasMin, bool hasMax, int min, int max)
{
...
void Settings::addParamList(stringref name, const vector<double>& defaultVal, bool hasMin, bool hasMax, double min, double max)
{
