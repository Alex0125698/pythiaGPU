...
public: // functions
  ...
  bool init(stringref startFile = "../xmldoc/Index.xml", bool append = false, ostream& os = cout)
  {
    static bool initialized = false;
    if (initialized) return true;
    int nError = 0;

    // resize setting lists
  ...
  bool readString(stringref line, bool warn, ostream& os) 
  {
