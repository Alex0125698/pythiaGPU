#ifndef Pythia8_ForwardDeclarations_H
#define Pythia8_ForwardDeclarations_H
...
// Helicity matrix element for a tau decay into two mesons through a vector or scalar meson resonance.
...
// A derived class with 2 -> 3 kinematics set up for central diffractive scattering.
class PhaseSpace2to3diffractive; // : public PhaseSpace;
// A derived class for nondiffractive events.
...
#endif // Pythia8_ForwardDeclarations_H
