...
public: // public functions
  ...
  void set(Word word, const string& value);
...
public: // private functions
  ...
  void addFlag(const string& name, bool defaultVal);
  void addMode(const string& name, int defaultVal, bool hasMin, bool hasMax, int min, int max, bool boundsError);
  void addParam(const string& name, double defaultVal, bool hasMin, bool hasMax, double min, double max);
  void addWord(const string& name, const string& defaultVal);
  void addFlagList(const string& name, const vector<bool>& defaultVal);
  void addModeList(const string& name, const vector<int>& defaultVal, bool hasMin, bool hasMax, int min, int max);
  void addParamList(const string& name, const vector<double>& defaultVal, bool hasMin, bool hasMax, double min, double max);

public: // more functions

  // load all settings from XML database
  bool init(const string& startFile = "../xmldoc/Index.xml", bool append = false, bool reinit = false, ostream& os = cout);

  // update setting using a string (Format: name = value)
  bool readString(const string& line, bool warn = true, ostream& os = cout);
  ...
  bool writeFile(const string& toFile, bool writeAll = false) ;
