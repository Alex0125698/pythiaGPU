...
public:
  ...
  // Constructors.
  SingleClusterJet(Vec4ref pJetIn = 0., int motherIn = 0) :
...
public:
  ...
  virtual bool include(int iSel, const Event& event, Vec4ref pSel,
    double& mSel) = 0;
...
public:
  ...
  // Constructors.
  SingleSlowJet(Vec4ref pIn = 0., double pT2In = 0., double yIn = 0.,
