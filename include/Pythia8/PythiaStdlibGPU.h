...
#ifndef Pythia8_PythiaStdlibGPU_H
#define Pythia8_PythiaStdlibGPU_H
...
// to help with GPU parallelism
using char_star = char*;
using int_star = int*;
using double_star = double*;
using bool_star = bool*;
using string_star = string*;
...
#endif // Pythia8_PythiaStdlibGPU_H
